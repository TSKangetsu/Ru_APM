...
void APMController_t::APMMessageREG()
{
	...
	UORB::ControllerStatus._NAV_Global_Speed[0] = nullptr;
	UORB::ControllerStatus._NAV_Global_Speed[1] = nullptr;
...
APMController_t::~APMController_t()
{
	...
	if (UORB::ControllerStatus._SYS_APMStatus != nullptr)
		UORB::ControllerStatus._SYS_APMStatus[0] = -2;
